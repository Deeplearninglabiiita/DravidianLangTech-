...
text_model_name = "ai4bharat/indic-bert"
...
class UnlabeledMemeDatasetForTest(Dataset):
    def __init__(self, csv_file, img_dir, tokenizer, max_length=128, transform=None, sep='\t'):
        self.data = pd.read_csv(csv_file)
        self.img_dir = img_dir
        self.tokenizer = tokenizer
...
test_dataset = UnlabeledMemeDatasetForTest(test_csv, test_img_dir, tokenizer, max_length=128, transform=image_transform)
...
test_data.to_csv("../Malayalam/predictions_ind_res_Malayalam.csv", index=False)
