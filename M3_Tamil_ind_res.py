...
Original file is located at
    https://colab.research.google.com/drive/14wwp8lAWp3XAvHVXgmq3yFyARq5BWGDP
"""
...
# Paths to data
train_csv = '/content/drive/MyDrive/NAACL 2025/Tamil/train.csv'
dev_csv = '/content/drive/MyDrive/NAACL 2025/Tamil/dev.csv'
test_csv = '/content/drive/MyDrive/NAACL 2025/Tamil/test.csv'
train_img_dir = '/content/drive/MyDrive/NAACL 2025/Tamil/train'
dev_img_dir = '/content/drive/MyDrive/NAACL 2025/Tamil/dev'
test_img_dir = '/content/drive/MyDrive/NAACL 2025/Tamil/test'

# Load IndicBERT tokenizer and model for text encoding
...
# Define multimodal classifier using IndicBERT and ResNet
...
# For test set, we only need text and image processing; labels are not available
...
test_data.to_csv("/content/drive/MyDrive/NAACL 2025/Tamil/predictions_ind_res.csv", index=False)
